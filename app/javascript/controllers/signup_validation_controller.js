...
export default class extends Controller {
  static targets = [
    ...
    "phone", "address", "dob", "role",
    "emailError", "usernameError", "firstNameError", "lastNameError",
    "passwordError", "passwordConfirmationError",
    "phoneError", "addressError", "dobError", "roleError",
    "passwordIcon"
  ]
  ...
  validateField(fieldName) {
    switch(fieldName) {
      ...
      case 'passwordConfirmation': return this.validatePasswordConfirmation()
      case 'phone': return this.validatePhone()
      case 'address': return this.validateAddress()
      case 'dob': return this.validateAge()
      case 'role': return this.validateRole()
    }
  }
  ...
  updateStepIndicators() {
    if (this.currentStep === 1) {
      ...
      this.step1IndicatorTarget.classList.add('border-indigo-600', 'bg-white', 'dark:bg-gray-800')
      this.step2IndicatorTarget.classList.remove('bg-indigo-600', 'text-white')
      this.step2IndicatorTarget.classList.add('border-gray-300', 'dark:border-gray-600')
    } else {
      this.step1IndicatorTarget.classList.remove('border-indigo-600', 'bg-white', 'dark:bg-gray-800')
      this.step1IndicatorTarget.classList.add('bg-indigo-600', 'text-white')
      this.step2IndicatorTarget.classList.remove('border-gray-300', 'dark:border-gray-600')
  ...
  validateStep1() {
    ...
    const isValid = isEmailValid && isUsernameValid && isFirstNameValid && 
                   isLastNameValid && isPasswordValid && isPasswordConfirmationValid
  ...
  validateUsername() {
    ...
    if (username.length < 3) {
      this.showError(this.usernameErrorTarget, "Username must be at least 3 characters")
      return false
    }
  ...
  validatePassword() {
    ...
    if (password.length < 8) {
      this.showError(this.passwordErrorTarget, "Password must be at least 8 characters")
      return false
    }
  ...
  validatePasswordConfirmation() {
    ...
    if (password !== confirmation) {
      this.showError(this.passwordConfirmationErrorTarget, "Passwords don't match")
      return false
    }
  ...
  togglePasswordVisibility() {
    ...
    const icon = this.passwordIconTarget
