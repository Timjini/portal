...
Rails.application.configure do
  ...
  config.action_cable.url = 'wss://staging.chambersforsport.com/cable'
  config.action_cable.allowed_request_origins = ['http://staging.chambersforsport.com', %r{http://chambersforsport.*}]
