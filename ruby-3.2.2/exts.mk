...
extensions = ext/-test-/RUBY_ALIGNOF/. ext/-test-/abi/. \
	     ...
	     ext/-test-/vm/. ext/-test-/wait/. ext/bigdecimal/. \
	     ext/cgi/escape/. ext/continuation/. ext/coverage/. \
	     ext/date/. ext/digest/. ext/digest/bubblebabble/. \
	     ext/digest/md5/. ext/digest/rmd160/. ext/digest/sha1/. \
	     ext/digest/sha2/. ext/erb/escape/. ext/etc/. ext/fcntl/. \
	     ext/fiddle/. ext/io/console/. ext/io/nonblock/. \
	     ext/io/wait/. ext/json/. ext/json/generator/. \
	     ext/json/parser/. ext/monitor/. ext/nkf/. ext/objspace/. \
	     ext/openssl/. ext/pathname/. ext/psych/. ext/pty/. \
	     ext/racc/cparse/. ext/rbconfig/sizeof/. ext/readline/. \
	     ext/ripper/. ext/rubyvm/. ext/socket/. ext/stringio/. \
	     ext/strscan/. ext/syslog/. ext/zlib/. \
	     .bundle/gems/debug-1.7.1/ext/debug/. \
	     .bundle/gems/rbs-2.8.2/ext/rbs_extension/.
EXTOBJS = dmyext.o
...
ext/zlib/all:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.7.1/ext/debug/all:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/static:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.7.1/ext/debug/static:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/install:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.7.1/ext/debug/install:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/install-so:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.7.1/ext/debug/install-so:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/install-rb:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.7.1/ext/debug/install-rb:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/debug-1.7.1/ext/debug/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
.bundle/gems/rbs-2.8.2/ext/rbs_extension/clean:
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
...
ext/zlib/distclean:
	...
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/debug-1.7.1/ext/debug/distclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/debug-1.7.1/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/rbs-2.8.2/ext/rbs_extension/distclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/rbs-2.8.2/exts.mk
	$(Q)$(RMDIRS) $(@D)
...
ext/zlib/realclean:
	...
	$(Q)$(RM) ext/zlib/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/debug-1.7.1/ext/debug/realclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/debug-1.7.1/exts.mk
	$(Q)$(RMDIRS) $(@D)
.bundle/gems/rbs-2.8.2/ext/rbs_extension/realclean:
	$(ECHO) $(@F)ing $(@D)
	$(Q)$(MAKE) -C $(@D) V=$(V) $(@F)
	$(Q)$(RM) .bundle/gems/rbs-2.8.2/exts.mk
	$(Q)$(RMDIRS) $(@D)
...
note-body:: note-header
	...
	@echo "	/home/runner/workspace/ruby-3.2.2/ext/fiddle/extconf.rb:73: missing libffi. Please install libffi or use --with-libffi-source-dir with libffi source location."
	@echo "	Check ext/fiddle/mkmf.log for more details."
	@$(NOTE_NAME) "openssl:"
	@echo "	Could not be configured. It will not be installed."
	@echo "	/home/runner/workspace/ruby-3.2.2/ext/openssl/extconf.rb:101: OpenSSL library could not be found. You might want to use --with-openssl-dir=<dir> option to specify the prefix where OpenSSL is installed."
	@echo "	Check ext/openssl/mkmf.log for more details."
	@$(NOTE_NAME) "psych:"
	@echo "	Could not be configured. It will not be installed."
	@echo "	Check ext/psych/mkmf.log for more details."
	@$(NOTE_NAME) "readline:"
	@echo "	Could not be configured. It will not be installed."
	@echo "	/home/runner/workspace/ruby-3.2.2/ext/readline/extconf.rb:62: Neither readline nor libedit was found"
