...
RSpec.describe '/admins/athlete_levels', type: :request do # rubocop:disable Metrics/BlockLength
  # This should return the minimal set of attributes required to create a valid
  # Admins::AthleteLevel. As you add validations to Admins::AthleteLevel, be sure to
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      Admins::AthleteLevel.create! valid_attributes
  ...
  describe 'GET /show' do
    it 'renders a successful response' do
      athlete_level = Admins::AthleteLevel.create! valid_attributes
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new Admins::AthleteLevel' do
        expect do
          post athlete_levels_url, params: { athlete_level: valid_attributes }
        end.to change(Admins::AthleteLevel, :count).by(1)
      end

      it 'redirects to the created athlete_level' do
        post athlete_levels_url, params: { athlete_level: valid_attributes }
        expect(response).to redirect_to(athlete_level_url(Admins::AthleteLevel.last))
      end
    end

    context 'with invalid parameters' do
      it 'does not create a new Admins::AthleteLevel' do
        expect do
          post athlete_levels_url, params: { athlete_level: invalid_attributes }
        end.to change(Admins::AthleteLevel, :count).by(0)
      end
