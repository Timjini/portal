...
class DcpaEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dcpa_event" do
    assert_difference("DcpaEvent.count") do
      post dcpa_events_url, params: { dcpa_event: { ages_available: @dcpa_event.ages_available, coach: @dcpa_event.coach, dates: @dcpa_event.dates, dcpa_discount: @dcpa_event.dcpa_discount, event_type: @dcpa_event.event_type, extras: @dcpa_event.extras, location: @dcpa_event.location, price: @dcpa_event.price, time_end: @dcpa_event.time_end, time_start: @dcpa_event.time_start, title: @dcpa_event.title } }
    end
  ...
  test "should update dcpa_event" do
    patch dcpa_event_url(@dcpa_event), params: { dcpa_event: { ages_available: @dcpa_event.ages_available, coach: @dcpa_event.coach, dates: @dcpa_event.dates, dcpa_discount: @dcpa_event.dcpa_discount, event_type: @dcpa_event.event_type, extras: @dcpa_event.extras, location: @dcpa_event.location, price: @dcpa_event.price, time_end: @dcpa_event.time_end, time_start: @dcpa_event.time_start, title: @dcpa_event.title } }
